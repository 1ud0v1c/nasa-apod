...
class DailyRequestWorkerTest: AutoCloseKoinTest() {
    ...
    @Before
    fun setUp() {
        val dailyRequestWorkerFactory = DailyRequestWorkerFactory(object: BitmapLoader {
    ...
    fun testDoWork(): Unit = runBlocking {
        ...
        val statusBarNotification: StatusBarNotification = notificationManager.activeNotifications[0]
